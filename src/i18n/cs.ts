...
export const cs = {
  ...
  "bill.list.empty.title": "Žádné uložené košíky",
  "bill.list.label": "Účet č. {number}",
  "bill.list.new.aria": "Založit nový košík",
  "bill.list.table.all": "Vše",
  "bill.list.table.none": "Bez stolu",
  ...
  "bill.park": "Odložit",
  "bill.list.viewAria": "Zobrazit uložené košíky",
