...
export const cs = {
  ...
  "checkout.bills.table.all": "Vše",
  "checkout.bills.table.none": "Bez stolu",
  ...
  "checkout.table.aria": "Přiřadit stůl",
  "checkout.table.assign": "Přiřadit stůl",
  "checkout.table.dialog.none": "Bez stolu",
  "checkout.table.dialog.title": "Vybrat stůl",
  ...
  "tables.empty.description":
    "Přidejte stoly ve svém podniku v nastavení a pak se sem vraťte, abyste viděli, které jsou volné.",
  "tables.empty.title": "Zatím žádné stoly",
