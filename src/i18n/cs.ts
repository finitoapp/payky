...
export const cs = {
  ...
  "paymentHistory.status.expired": "Vypršelo",
  ...
  "paymentDetail.bill.status.open": "Otevřeno",
  ...
  "paymentDetail.status.expired": "Vypršelo",
  ...
  "settings.tables.delete.confirm.description":
    "Účty, které už jsou přiřazené ke stolu {name}, si ho ponechají, ale nepůjde ho přiřadit k novým.",
  ...
  "settings.tables.form.save.edit": "Uložit změny",
  "settings.tables.form.saved.create": "Stůl přidán.",
  "settings.tables.form.saved.edit": "Stůl upraven.",
  ...
  "settings.tips.description": "Nastavení dýška pro účty",
