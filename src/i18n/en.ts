export const en = {
  ...
  "checkout.bills.empty.description":
    "Carts you save from checkout appear here.",
  "checkout.bills.empty.title": "No saved carts",
  "checkout.bills.label": "Bill #{number}",
  "checkout.bills.new.aria": "Start a new cart",
  "checkout.bills.table.all": "All",
  "checkout.bills.table.none": "No table",
  "checkout.bills.title": "Saved carts",
  "checkout.bill.closed": "This cart has already been settled.",
  "checkout.bill.notFound": "This cart no longer exists.",
  "checkout.brick.add.aria": "Add {name}",
  "checkout.brick.quantity.cancel": "Cancel",
  "checkout.brick.quantity.confirm": "Add",
  "checkout.brick.quantity.description":
    "How many would you like to add to the cart?",
  "checkout.brick.quantity.input.aria": "Quantity",
  "checkout.brick.quantity.trigger.aria": "Enter quantity for {name}",
  "checkout.brick.remove.aria": "Remove {name}",
  "checkout.category.all": "All",
  "checkout.category.uncategorized": "Uncategorized",
  "checkout.discard": "Discard cart",
  "checkout.table.aria": "Assign table",
  "checkout.table.assign": "Assign table",
  "checkout.table.dialog.none": "No table",
  "checkout.table.dialog.title": "Select table",
  "checkout.discard.confirm.cancel": "Keep cart",
  "checkout.discard.confirm.confirm": "Discard",
  "checkout.discard.confirm.description":
    "All items in this cart will be removed. This can't be undone.",
  "checkout.discard.confirm.title": "Discard this cart?",
  "checkout.emptySearch": "No items match your search.",
  "checkout.itemsCount": "Items: {value}",
  "checkout.park": "Park",
  "checkout.savedCarts.aria": "View saved carts",
  "checkout.search": "Search items...",
  "checkout.search.clear.aria": "Clear search",
  "checkout.summary.clear": "Clear",
  "checkout.summary.clear.toast": "Cart cleared",
  "checkout.summary.redo": "Redo",
  "checkout.summary.removeLine.aria": "Remove {name} from cart",
  "checkout.summary.removeLine.toast": "{name} removed",
  "checkout.summary.undo": "Undo",
  ...
  "paymentWait.closeBillError": "Could not close the paid bill.",
  ...
  "settings.categories.form.card.description":
    "Name shown when grouping items and filtering the checkout.",
  ...
  "tables.empty.description":
    "Add the tables in your venue in settings, then come back here to see which ones are free.",
