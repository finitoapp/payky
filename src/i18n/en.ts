export const en = {
  ...
  "bill.list.empty.description": "Carts you save from a bill appear here.",
  "bill.list.empty.title": "No saved carts",
  "bill.list.label": "Bill #{number}",
  "bill.list.new.aria": "Start a new cart",
  "bill.list.table.all": "All",
  "bill.list.table.none": "No table",
  "bill.list.title": "Saved carts",
  ...
  "bill.park": "Park",
  "bill.list.viewAria": "View saved carts",
