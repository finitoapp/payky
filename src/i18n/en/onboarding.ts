export const enOnboarding = {
  ...
  "onboarding.payments.bankAccount.bankDetected": "Account at {bank}.",
  "onboarding.payments.bankAccount.bankUnknown":
    "The bank code is not in the list yet; the account is still valid.",
  "onboarding.payments.bankAccount.description":
    "Czech or Slovak account number (e.g. 19-2000145399/0800) or an IBAN.",
  "onboarding.payments.bankAccount.label": "Bank account for transfers",
  "onboarding.payments.bankAccount.placeholder":
    "123456789/0800 or CZ65 0800 …",
  "onboarding.payments.skipHint":
    "No account yet? Leave it empty and add it later in Settings. Bitcoin payments over cashu are on from the start.",
  "onboarding.payments.description":
    "Where bank transfers should arrive. You can change this later.",
  "onboarding.payments.title": "Bank account",
