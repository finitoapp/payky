...
export const sk = {
  ...
  "checkout.bills.empty.description":
    "Uložené košíky sa tu zobrazia, keď nejaký uložíte.",
  "checkout.bills.empty.title": "Žiadne uložené košíky",
  "checkout.bills.label": "Účet č. {number}",
  "checkout.bills.new.aria": "Založiť nový košík",
  "checkout.bills.table.all": "Všetko",
  "checkout.bills.table.none": "Bez stola",
  "checkout.bills.title": "Uložené košíky",
  "checkout.bill.closed": "Tento košík je už vyriadený.",
  "checkout.bill.notFound": "Tento košík už neexistuje.",
  "checkout.brick.add.aria": "Pridať {name}",
  "checkout.brick.quantity.cancel": "Zrušiť",
  "checkout.brick.quantity.confirm": "Pridať",
  "checkout.brick.quantity.description": "Koľko kusov chcete pridať do košíka?",
  "checkout.brick.quantity.input.aria": "Počet kusov",
  "checkout.brick.quantity.trigger.aria": "Zadať počet kusov {name}",
  "checkout.brick.remove.aria": "Odobrať {name}",
  "checkout.category.all": "Všetko",
  "checkout.category.uncategorized": "Bez kategórie",
  "checkout.table.aria": "Priradiť stôl",
  "checkout.table.assign": "Priradiť stôl",
  "checkout.table.dialog.none": "Bez stola",
  "checkout.table.dialog.title": "Vybrať stôl",
  "checkout.discard": "Zahodiť košík",
  "checkout.discard.confirm.cancel": "Zachovať košík",
  "checkout.discard.confirm.confirm": "Zahodiť",
  "checkout.discard.confirm.description":
    "Všetky položky v tomto košíku budú odstránené. Túto akciu nemožno vrátiť.",
  "checkout.discard.confirm.title": "Zahodiť tento košík?",
  "checkout.emptySearch": "Vyhľadávanie nenašlo žiadne položky.",
  "checkout.itemsCount": "Položky: {value}",
  "checkout.park": "Odložiť",
  "checkout.savedCarts.aria": "Zobraziť uložené košíky",
  "checkout.search": "Hľadať položky...",
  "checkout.search.clear.aria": "Vymazať hľadanie",
  "checkout.summary.clear": "Vyprázdniť",
  "checkout.summary.clear.toast": "Košík vyprázdnený",
  "checkout.summary.redo": "Znova",
  "checkout.summary.removeLine.aria": "Odobrať {name} z košíka",
  "checkout.summary.removeLine.toast": "{name} odobraté",
  "checkout.summary.undo": "Späť",
  ...
  "paymentWait.closeBillError": "Zaplatený účet sa nepodarilo uzavrieť.",
  ...
  "settings.categories.form.card.description":
    "Názov zobrazený pri zoskupovaní položiek a filtrovaní v pokladni.",
  ...
  "tables.empty.description":
    "Pridajte stoly vo svojej prevádzke v nastaveniach a potom sa sem vráťte, aby ste videli, ktoré sú voľné.",
  "tables.empty.title": "Zatiaľ žiadne stoly",
