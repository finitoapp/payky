...
export const sk = {
  ...
  "bill.list.empty.description":
    "Uložené košíky sa tu zobrazia, keď nejaký uložíte.",
  "bill.list.empty.title": "Žiadne uložené košíky",
  "bill.list.label": "Účet č. {number}",
  "bill.list.new.aria": "Založiť nový košík",
  "bill.list.table.all": "Všetko",
  "bill.list.table.none": "Bez stola",
  "bill.list.title": "Uložené košíky",
  ...
  "bill.park": "Odložiť",
  "bill.list.viewAria": "Zobraziť uložené košíky",
