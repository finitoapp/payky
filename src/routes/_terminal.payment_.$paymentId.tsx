...
const successRedirectDelayMs = 1_250
...
function PaymentWaitingRequest({
  ...
  }, [isPaid, navigate, paymentId, successVisible])
  ...
  return (
    <>
      ...
      <div className="flex min-h-full flex-col justify-between gap-8">
        <section className="flex flex-1 flex-col items-center justify-center gap-7 text-center">
            ...
            <Card className={"bg-white w-full aspect-square"}>
              <CardContent>
                {qrPayload ? (
                  ...
                  <p className="max-w-56 text-balance text-sm text-white/55">
                    {t("paymentWait.missingRequest")}
                  </p>
                )}
              </CardContent>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-5 text-white">
              <NfcIcon className="size-6" strokeWidth={3} />
        ...
        <div
          className={cn(
            "absolute inset-0 flex items-center justify-center bg-[#071012]/95 transition-opacity duration-300",
            successVisible ? "opacity-100" : "pointer-events-none opacity-0"
          )}
          aria-hidden={!successVisible}
        >
          <div className="flex flex-col items-center gap-5 text-center">
            <div className="flex size-24 items-center justify-center rounded-full bg-white text-[#071012]">
